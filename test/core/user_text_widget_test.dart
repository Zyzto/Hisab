...
void main() {
    ...
    await tester.pumpWidget(
      const MaterialApp(
        home: Directionality(
          textDirection: TextDirection.rtl,
          child: Scaffold(
            body: UserText('abcd', textAlign: TextAlign.center),
          ),
        ),
      ),
    );
  ...
  testWidgets(
    'Latin glyphs sit beside leading avatar in RTL Expanded row',
    (tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Directionality(
  ...
  testWidgets(
    'Arabic glyphs sit beside leading avatar in LTR Expanded row',
    (tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Directionality(
