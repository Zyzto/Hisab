...
class HomePage extends ConsumerWidget {
    ...
    showModalBottomSheet<void>(
      ...
      builder: (ctx) => Consumer(
        builder: (context, ref, _) {
          final display = ref.watch(homeListDisplayProvider);
              ...
              child: Column(
                ...
                children: [
                  ...
                  ListTile(
                    ...
                    trailing: DropdownButton<String>(
                      ...
                      items: [
                        DropdownMenuItem(
                          value: 'separate',
                          child: Text('home_list_display_separate'.tr()),
                        ),
                        DropdownMenuItem(
                          value: 'combined',
                          child: Text('home_list_display_combined'.tr()),
                        ),
                      ],
                      onChanged: (v) {
                        if (v != null) {
                  ...
                  SwitchListTile(
                    ...
                    onChanged: (v) {
                      ref
                          .read(settings.provider(homeListShowCreatedAtSettingDef).notifier)
                          .set(v);
                    },
                  ),
                ],
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final displaySeparate = ref.watch(homeListDisplayProvider) == 'separate';
    ...
    final pinnedSet = pinnedIdsRaw
        ...
        .toSet();
    final selectionAllPinned = selectedIds.isNotEmpty &&
    ...
    void pinSelected() {
      ...
      ref
          .read(
            settings.provider(homeListPinnedIdsSettingDef).notifier,
          )
          .set(list.join(','));
      clearSelection();
    }
    ...
    return PopScope(
            ...
            ? AppBar(
                ...
                actions: [
                  IconButton(
                    ...
                    onPressed:
                        selectionAllPinned ? unpinSelected : pinSelected,
                    tooltip:
                        selectionAllPinned ? 'unpin'.tr() : 'pin'.tr(),
                  ),
                ],
              )
            : AppBar(
      ...
      body: AsyncValueBuilder<List<Group>>(
        ...
        data: (context, ordered) {
          ...
          if (isEmpty) {
            return wrapRefresh(LayoutBuilder(
          ...
          Widget buildCard(Group group) {
            return GroupCard(
              ...
              onLongPress: () {
                final cur = ref.read(selectedGroupIdsProvider);
                if (cur.isEmpty) {
                  ref.read(selectedGroupIdsProvider.notifier).state = {group.id};
                } else {
                  toggleSelection(group.id);
                }
              },
          ...
          void persistOrder(List<Group> newOrder) {
            ...
            ref
                .read(
                  settings.provider(homeListCustomOrderSettingDef).notifier,
                )
                    ...
                    if (sortCustom && inSelectionMode)
                      ReorderableListView(
                        ...
                        onReorder: (oldIndex, newIndex) {
                          ...
                          final newPersonal = List<Group>.from(personal);
          ...
          return wrapRefresh(sortCustom && inSelectionMode
                ? ReorderableListView(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    buildDefaultDragHandles: false,
                    onReorder: (oldIndex, newIndex) {
