...
emit HISAB_ENV "${HISAB_ENV:-}"
emit HISAB_AUTH_SCHEME "${HISAB_AUTH_SCHEME:-}"
emit GOOGLE_WEB_CLIENT_ID "${GOOGLE_WEB_CLIENT_ID:-}"
emit GOOGLE_IOS_CLIENT_ID "${GOOGLE_IOS_CLIENT_ID:-}"
emit HISAB_PLUS_ENABLED "${HISAB_PLUS_ENABLED:-}"
emit REVENUECAT_APPLE_API_KEY "${REVENUECAT_APPLE_API_KEY:-}"
emit REVENUECAT_GOOGLE_API_KEY "${REVENUECAT_GOOGLE_API_KEY:-}"
emit REVENUECAT_WEB_API_KEY "${REVENUECAT_WEB_API_KEY:-}"
emit REVENUECAT_ENTITLEMENT_ID "${REVENUECAT_ENTITLEMENT_ID:-}"
